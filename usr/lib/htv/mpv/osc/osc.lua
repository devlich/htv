...
local user_opts = {
	...
	scalewindowed = 1.8,				-- scaling of the controller when windowed (vidscale false 4K)
	scalefullscreen = 1.8,				-- scaling of the controller when fullscreen (vidscale false 4K)
